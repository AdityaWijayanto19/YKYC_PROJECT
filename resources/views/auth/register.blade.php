...
<body class="font-sans">
    ...
    <div class="min-h-screen md:flex">
        ...
        <div class="hidden md:block md:w-1/2 md:h-screen relative bg-cover bg-center "
            ...
            <div class="p-12 flex flex-col justify-between h-full">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-white text-opacity-90 mt-2">Daftar sekarang untuk mendapatkan layanan terbaik kami.
                    </p>
                </div>
            </div>
        </div>
