        ...
        <div class="hidden md:block md:w-1/2 relative bg-cover bg-center h-screen"
            ...
            <div class="absolute inset-0 p-12 flex flex-col justify-end">
                <div class="relative z-10">
                    ...
                    <p class="text-white text-opacity-90 mt-2 text-lg">Daftar sekarang untuk mendapatkan layanan cuci
                        terbaik kami.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-full flex flex-col">
            ...
            <div class="p-6 space-y-4 overflow-y-auto">
                <p class="text-gray-600">Mohon baca Syarat dan Ketentuan ("Ketentuan") ini dengan saksama sebelum
                    menggunakan layanan "Ya Kotor Ya Cuci". Dengan mendaftar dan menggunakan layanan kami, Anda setuju
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Kami berkomitmen untuk memberikan layanan pencucian dengan kualitas
                        terbaik. Namun, kami tidak bertanggung jawab atas kerusakan pada pakaian yang disebabkan oleh
                        bahan yang tidak tahan cuci (luntur, susut) atau benda asing yang tertinggal di saku pakaian
                        (pena, koin, dll.).</p>
                </div>

                <div>
                    <h4 class="font-semibold text-gray-700">3. Barang Hilang atau Rusak</h4>
                    <p class="text-gray-600 mt-1">Keluhan mengenai barang yang hilang atau rusak harus dilaporkan dalam
                        waktu 1x24 jam setelah pengiriman. Kompensasi, jika ada, tidak akan melebihi 5 kali biaya cuci
                        dari barang yang bersangkutan dan akan melalui proses investigasi internal terlebih dahulu.</p>
                </div>

                <div>
                    <h4 class="font-semibold text-gray-700">4. Pembayaran</h4>
                    <p class="text-gray-600 mt-1">Semua pembayaran harus diselesaikan sesuai dengan tagihan sebelum atau
                        pada saat pakaian Anda diantar kembali. Kami menerima berbagai metode pembayaran yang tertera di
                        aplikasi.</p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Kami menghargai privasi Anda. Informasi pribadi yang Anda berikan
                        hanya akan digunakan untuk keperluan penyediaan layanan dan tidak akan dibagikan kepada pihak
                        ketiga tanpa persetujuan Anda.</p>
                </div>

                <p class="pt-2 text-sm text-gray-500">Dengan menekan tombol "Saya Setuju", Anda mengonfirmasi bahwa Anda
                    telah membaca, memahami, dan menyetujui seluruh Syarat & Ketentuan yang berlaku.</p>
            </div>

            <div class="flex items-center justify-end p-5 border-t space-x-4">
                <button id="close-modal-btn" type="button"
                    class="px-6 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none">
                    Tutup
                </button>
                <button id="agree-btn" type="button"
                    class="px-6 py-2 text-white bg-primary rounded-lg hover:bg-blue-600 focus:outline-none">
                    Saya Setuju
                </button>
            </div>
        </div>
