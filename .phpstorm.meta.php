...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\YaKotorYaCuci\public\storage' => 'string',
            ...
            'midtrans.serverKey' => 'string',
            'midtrans.clientKey' => 'string',
            'midtrans.isProduction' => 'boolean',
            'midtrans.isSanitized' => 'boolean',
            'midtrans.is3ds' => 'boolean',
...
'filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\YaKotorYaCuci\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.markdown.theme','mail.markdown.paths','midtrans.serverKey','midtrans.clientKey','midtrans.isProduction',
'midtrans.isSanitized','midtrans.is3ds','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'register','login','logout','landing','login','register','customer.dashboard',
'customer.order.create','customer.order.status','customer.locations','customer.tracking','customer.history',
'customer.notifications','customer.feedback.create','worker.dashboard','worker.pesanan.actived','worker.pesanan.history',
'worker.location.chart','worker.notifications','worker.profil','admin.dashboard','admin.worker.index',
'admin.worker.location-chart','admin.worker.tambah','admin.worker.edit','admin.customer.index','admin.customer.edit',
'admin.pesanan','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.customer.edit','admin.customer.index','admin.dashboard','admin.pesanan','admin.worker._form',
'admin.worker.edit','admin.worker.index','admin.worker.location-chart','admin.worker.tambah','auth.login',
'auth.register','checkout','components.sidebar-customer','components.sidebar-link-customer','customer.dashboard',
'customer.feedback','customer.history','customer.locations','customer.notifications','customer.order',
'customer.order_status','customer.tracking','landing','layouts.admin','layouts.customer',
'layouts.worker','worker.dashboard','worker.history-pesanan','worker.location-chart','worker.notifications',
'worker.pesanan-actived','worker.profil','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'REDIS_PASSWORD','REDIS_PORT','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_CALLBACK',
'MIDTRANS_SERVER_KEY','MIDTRANS_CLIENT_KEY','MIDTRANS_IS_PRODUCTION','MIDTRANS_IS_SANITIZED','MIDTRANS_IS_3DS',
